...
Usage:
    >>> from clio_agent.tools.data_tools import hdf5_analyze
    >>> from clio_agent.tools import call_mcp
    >>>
    >>> # Use tool directly
...
from clio_agent.tools.mcp_wrapper import call_tool, MCPError

# Import tool categories
# TODO: Uncomment when tools are implemented
# from clio_agent.tools.data_tools import (
#     hdf5_analyze,
#     hdf5_optimize,
#     adios_convert,
#     parquet_optimize,
# )
# from clio_agent.tools.hpc_tools import (
#     slurm_analyze,
#     darshan_report,
# )
