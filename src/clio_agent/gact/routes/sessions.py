...
def register_sessions_routes(app: FastAPI, deps: "GactDeps") -> None:
    ...
    async def answer_user_question(
        ...
        # P1.4 #1066 (plan-exit) + P1.3 #1113 (MCP elicitation) reuse THIS answer surface
        # (no new store); their non-default resolution is dispatched in the owner module.
        from clio_agent.gact.elicitation_bridge import resolve_answered_question  # noqa: PLC0415
