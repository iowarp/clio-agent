...
def build_create_artifact_tool(agent_def: "AgentDef") -> Any:
    """Build the native designation tool while preserving this public factory."""
    from clio_agent.gact.artifacts.designation_tool import build_create_artifact_tool as build

    return build(agent_def)
