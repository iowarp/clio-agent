...
def build_create_artifact_tool(agent_def: "AgentDef") -> Any:
    ...
    def create_artifact(
        ...
        (paths, artifact ids, an uploaded attachment's ``res_...`` id, and/or exact
        HTTP(S) source URLs). NOT threaded into the promotion below —
    ...
    return native_tool(
        ...
        desc=(
            ...
            "res_... id or its .clio/inputs/<res_id>/<name> working-copy path, "
        ...
        args={
            ...
            "used": {
                "type": "array",
                "description": (
                    "OPTIONAL: workspace paths, artifact ids, an uploaded attachment's "
                    "res_... id, and/or exact HTTP(S) source URLs this deliverable was "
                    "derived from. URLs are assertion-class evidence; "
