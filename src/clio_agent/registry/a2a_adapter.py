...
(LangChain, CrewAI, AutoGen) into ClioAgent's agent ecosystem via the
Agent-to-Agent (A2A) protocol.

Example:
    >>> from clio_agent.registry.a2a_adapter import A2AProtocolHandler, A2ARequest
    >>>
...
class A2AProtocolHandler:
    ...
    Example:
        ...
        >>> from clio_agent.registry.a2a_adapter import A2AAdapter
