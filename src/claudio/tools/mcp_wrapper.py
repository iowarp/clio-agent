...
FastMCP-based client for calling ClaudIO MCP tool servers.
...
Usage:
    >>> from claudio.tools.mcp_wrapper import get_mcp_client, call_tool
    >>>
...
@dataclass
class MCPConfig:
    """Configuration for ClaudIO MCP servers.
    ...
    def __post_init__(self):
        if self.servers is None:
            ...
            self.servers = {
                ...
                # "darshan": {
                #     "command": "python",
                #     "args": ["src/claudio/tools/servers/darshan_server.py"]
                # }
            }
...
if __name__ == "__main__":
    print("ClaudIO MCP Wrapper Test (FastMCP-based)")
    print("=" * 60)
    ...
    if not any(is_server_available(s) for s in _config.servers.keys()):
        ...
        print("  uv run src/claudio/tools/servers/hdf5_server.py")
