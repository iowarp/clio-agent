...
RATCHET_BASELINE: dict[str, int] = {
    ...
    # Ratchet down 1163 -> 1148 (S1b, Codex SDK transport restore): the whole
    # codex readiness gate (SDK-vs-direct dispatch + the 401/503 raise) moved
    # to the new owner module gact/routes/codex_variant.py; only the bind's
    # own codex_variant kwarg and one gate call land here.
    "src/clio_agent/gact/routes/providers.py": 1148,
