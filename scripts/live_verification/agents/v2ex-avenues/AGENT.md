...
`v2ex_staller`, `v2ex_plain_staller`, `v2ex_silent_sleeper`) -- the same
Agent Blueprint mechanism `agents/v2ex-testing/` and `agents/web-testing/`
already prove works (#1301). Rides the SAME materialization mechanics
