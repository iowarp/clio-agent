...
| R11 | CLIO command/capability audit: [COMMAND_CAPABILITY_AUDIT.md](COMMAND_CAPABILITY_AUDIT.md) | Truthful command availability, visible TODO commands, permissions, rewind, and unsupported voice semantics. |
| R12 | CLIO memory refinement design: [MEMORY_SYSTEM_REFINEMENT.md](MEMORY_SYSTEM_REFINEMENT.md) | Context-frame truth, provenance, compaction events, and cross-session access constraints. |
