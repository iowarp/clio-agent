...
| `CLIO_CAPTURE_REASONING` | `runtime.capture_reasoning` | bool | `true` | `src/clio_agent/gact/turn_finalize.py` |
...
| `CLIO_DISABLE_JSON_ADAPTER_FALLBACK` | `lm.disable_json_adapter_fallback` | bool | `false` | `src/clio_agent/config.py` |
| `CLIO_DUMP_UNPARSEABLE` | `debug.dump_unparseable` | str | _(unset)_ | `src/clio_agent/config.py` |
...
| `CLIO_LIVE_STREAMING` | `runtime.live_streaming` | bool | `true` | `src/clio_agent/config.py` |
...
| `CLIO_LM_DISABLE_THINKING` | `lm.disable_thinking` | bool | `false` | `src/clio_agent/config.py` |
| `CLIO_LM_GUIDED_OUTPUT` | `lm.guided_output` | bool | `false` | `src/clio_agent/config.py` |
...
| `CLIO_LM_PARSE_RETRY_ATTEMPTS` | `limits.lm_parse_retry_attempts` | str | _(unset)_ | `src/clio_agent/config.py` |
...
| `CLIO_LM_REASONING_MODEL` | `lm.reasoning_model` | str | _(unset)_ | `src/clio_agent/config.py` |
| `CLIO_LM_STOP_SEQUENCES` | `lm.stop_sequences` | str | _(unset)_ | `src/clio_agent/config.py` |
| `CLIO_LM_TEMPERATURE` | `lm.temperature` | float | _(unset)_ | `src/clio_agent/config.py` |
| `CLIO_LM_TOKEN_LIVENESS` | `runtime.lm_token_liveness` | bool | `true` | `src/clio_agent/config.py` |
...
| `CLIO_LM_TRANSIENT_BACKOFF_S` | `limits.lm_transient_backoff_s` | float | `8.0` | `src/clio_agent/config.py` |
| `CLIO_LM_TRANSIENT_RETRIES` | `limits.lm_transient_retries` | float | `2.0` | `src/clio_agent/config.py` |
