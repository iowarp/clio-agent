...
catalogs explicitly in the marketplace (base-agent, factorio-flat and
spotter-ai list `clio-workspace`; EarthScope lists `earthscope-stations`,
then `clio-workspace`), and those packs require clio-agent 0.9.4.17 or newer.
