"""Caller-relative summarizer identity regressions (#1322)."""
...
def test_empty_role_reuses_effective_caller_exactly() -> None:
...
def test_model_only_summary_override_keeps_caller_endpoint_and_credential(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setenv("CLIO_SUMMARIZER_MODEL", "summary-model")
    conf.reload()
