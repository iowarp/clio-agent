...
- ClioAgent initialization, routing, blueprint dispatch, ARC instrumentation, and local direct-tool answers
...
Running Tests:
    ...
    # Single test
    pytest tests/test_gact/test_agent_blueprints.py::test_blueprint_compiler_selects_declared_dspy_module_kind -v
